...
if (process.argv.length <= 2) {
	console.log("Usage: node murder.js <url> <time>");
	console.log("Usage: node murder.js <http://example.com> <60>");
	process.exit(-1);
}
...
try {
    var proxies = [...new Set(fs.readFileSync('murder.txt').toString().match(/\S+/g))];
} catch (err) {
